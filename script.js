// Banco de dados oficial atualizado com as 4 candidatas e suas fotos limpas
const candidatos = {
"01": { nome: "Bruna S.", partido: "Chapa Estudantil A", foto: "BGato" },    
    "02": { nome: "Maria Eduarda", partido: "Chapa Estudantil B", foto: "MCoelho" },
"03": { nome: "Ana Clara", partido: "Chapa Estudantil C", foto: "APanda" },
    "04": { nome: "Beatriz M.", partido: "Chapa Estudantil D", foto: "BCao" }
};
...
function buscarCandidato() {
    ...
    if (candidato) {
        ...
        el.fotoContainer.innerHTML = ""; // Voto nulo não mostra foto
    }
}
...
function votarBranco() {
    ...
    el.fotoContainer.innerHTML = ""; // Voto branco não mostra foto
}
